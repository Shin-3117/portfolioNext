    ...
    <article className="p-4 m-4 bg-stone-100 rounded-2xl w-[90vw] max-w-[1200px]">
      <section>
        <div className="relative mb-4">
          <h3 className="text-center text-2xl font-bold">MovieSelector</h3>
          <a
        ...
        <div className="center flex-col">
          <Image src={projectImg} width={600} alt="UH시작화면" />

          <p>
            애정하는 영화 리뷰 및 평점 등록 사이트입니다. 4인 팀 프로젝트입니다.
          </p>
      ...
      <section className="center flex-col p-4">
        <div>
            ...
            <ul className="mb-2">
              <li className="pb-1">
                ...
                <div className="lg:flex">
                  <Image src={LayoutImg} width={500} alt="Project Layout" />
                  <div>
                    <p>
                      - Create React App으로 프로젝트 세팅을 하고, Route를
                      이용해 Layout을 구현했습니다.
                    </p>
                    <p>- header, main, footer로 분리했습니다.</p>
                    <p>
                      -- header에는 로고, 검색창, 로그인 버튼, 마이페이지 버튼,
                      로그아웃 버튼이 있습니다.
                    </p>
                    <p>
                      -- footer에는 로고, 팀원, 깃허브 주소 등의 정보가
                      있습니다.
                    </p>
                  </div>
                </div>
              ...
              <li className="pb-1">
                <h5>인증 기능 구현</h5>
                <div className="lg:flex">
                  <Image src={AuthImg} width={500} alt="Project Layout" />
                  <div>
                    <p>
                      - 로그인, 회원가입, 관리자 로그인, 관리자 회원가입을
                      구현했습니다.
                    </p>
                    <p>
                      - input에 유효성 검사를 적용하여, 부적합한 경우
                      에러메세지를 출력합니다.
                      <br /> 적합한 경우만 서버로 로그인 요청을 보냅니다.
                    </p>
                    <p>
                      - <code>useLocation()</code>를 사용하여 로그인 완료 후,
                      사용자가 보던 페이지로 이동시킵니다.
                    </p>
                    <p>
                      관리자 로그인의 경우는 로그인 성공시, 백오피스 페이지로
                      이동합니다.
                    </p>
                  </div>
                </div>
              ...
              <li className="pb-1">
                ...
                <div className="lg:flex">
                  <Image
                    src={BackOfficePageImg}
                    width={500}
                    alt="Project Layout"
                  />
                  <div>
                    <p>- 사이트에 등록된 영화, 유저, 댓글 관리가 가능합니다.</p>
                    <p>
                      - 영화의 경우 CRUD에서 Delete는 불가능 합니다. (백엔드에서
                      요청)
                    </p>
                    <p>- 검색창을 통해 찾으려는 항목을 검색할 수 있습니다.</p>
                    <p>
                      - 수정 버튼을 클릭하면, 모달창이 출력되고 내용 수정이
                      가능합니다.
                    </p>
                    <p>
                      - 삭제는 체크박스를 통해 일괄 삭제, 혹은 삭제 버튼을 통한
                      단일 데이터 삭제가 가능합니다.
                    </p>
                  </div>
                </div>
          ...
          <section className="relative">
            ...
            <ul className="mb-2">
              <li className="pb-1">
                <h5>BackOffice Table</h5>
                <p>
                  - Table tag를 사용하려 했지만 SEO에 좋지않다는 강사님의 말에
                  따라 ul li 구조로 변경했습니다.
                </p>
                <p>
                  - CSS처리를 flex로 했을 때, li별 ui가 일치 하지 않아 grid를
                  사용해 구현했습니다.
                </p>
                <p>
                  - Sass를 통해 CSS의 분기처리를 통해 재사용성을 높였습니다.
                </p>
