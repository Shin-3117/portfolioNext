...
export default function UH() {
  return (
    <article className="p-4 m-4 bg-stone-100 rounded-2xl w-[90vw]">
      <section>
        ...
        <section className="w-full max-w-[1200px] ">
          ...
          <ul className="mb-2">
            <li className="pb-1">
              ...
              <p>
                - OpenVidu 라이브러리를 활용하여 유저 간의 통신을 구현했습니다.
              </p>
            </li>
            ...
            <li className="pb-1">
              ...
              <p>3. 대기방 채팅 구현</p>
              <p>
                - session에 있는 socket을 이용하여 유저 간의 통신을 통해 채팅을
                구연했습니다.
              </p>
            ...
            <li className="pb-1">
              ...
              <p>
                ...
                <code>useEffect()</code>, <code>Date.now()</code>와 meter tag를
                사용하여 구연하였습니다.
              </p>
              <p>
                -- <code>useRef()</code>로 <code>Date.now()</code>를 통해 타이머
                시작 시간과 현재 시간을 비교하여 시간을 측정합니다.
              </p>
              <p>
              ...
              <p>
                - 게임 종료시, 게임 결과를 서버로 보내고, 대기방으로 돌아갑니다.
              </p>
            </li>
            <li className="pb-1">
              <h5>게임: 인물 맞추기</h5>
